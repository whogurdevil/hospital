...
const Profile = ({ user }) => {
    ...
    useEffect(() => {
        setFormData({ name: user.name, email: user.email, photo: user.photo, qualifications:user.qualifications })
    }, [user]);
    ...
    const submitHandler = async (event) => {
        ...
        try {
            const res = await axios.put(`${BASE_URL}/doctors/${user._id}`, formData, {
                headers: {
